...
if !exists("python_no_builtin_highlight")
  ...
  " built-in functions
  syn keyword pythonBuiltin	index
  ...
  syn keyword pythonStringFunc	split replace
  syn keyword pythonArrayFunc	append insert
  syn keyword pythonFileFunc	read readlines close write
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonOper		Include
  HiLink pythonStatement	Statement
  HiLink pythonConditional	Include
  HiLink pythonRepeat		Include
